...
# MAGIC USING (
# MAGIC     SELECT *
# MAGIC     FROM staging_Services_Stg
# MAGIC     WHERE `__$operation` IN (1,2,4)
# MAGIC ) AS source
...
# MAGIC %%sql
# MAGIC --merge support groups
# MAGIC 
# MAGIC 
# MAGIC MERGE INTO bronze_SupportGroups_Stg AS target
# MAGIC USING (
# MAGIC     SELECT *
# MAGIC     FROM staging_SupportGroups_Stg
# MAGIC     WHERE `__$operation` IN (1,2,4)
# MAGIC ) AS source
...
# MAGIC USING (
# MAGIC     SELECT *
# MAGIC     FROM staging_TicketWorklogs_Stg
# MAGIC     WHERE `__$operation` IN (1,2,4)
# MAGIC ) AS source
